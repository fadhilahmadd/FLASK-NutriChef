    ...
    for category in requested_categories:
        if category == 'Kentang':
            ...
            data = {
                ...
                "strCategoryThumb": "http://192.168.0.192:5000/img/kembang-kol.png",
            ...
            data = {
                "idCategory": "3",
                "strCategory": "Kubis",
                "strCategoryThumb": "http://192.168.0.192:5000/img/kubis.png",
            ...
            data = {
                "idCategory": "4",
                "strCategory": "Labu",
                "strCategoryThumb": "http://192.168.0.192:5000/img/labu.png",
                "strCategoryDescription": "Dessert is a course that concludes a meal..."
            }
            ...
            data = {
                "idCategory": "5",
                "strCategory": "Paprika",
                "strCategoryThumb": "http://192.168.0.192:5000/img/paprika.png",
                "strCategoryDescription": "Dessert is a course that concludes a meal..."
            }
        elif category == 'Timun':
            data = {
                "idCategory": "6",
                "strCategory": "Timun",
                "strCategoryThumb": "http://192.168.0.192:5000/img/timun.png",
                "strCategoryDescription": "Dessert is a course that concludes a meal..."
            }
        elif category == 'Tomat':
            data = {
                "idCategory": "7",
                "strCategory": "Tomat",
                "strCategoryThumb": "http://192.168.0.192:5000/img/tomat.png",
                "strCategoryDescription": "Dessert is a course that concludes a meal..."
            }
            ...
            data = {
                "idCategory": "8",
                "strCategory": "Wortel",
                "strCategoryThumb": "http://192.168.0.192:5000/img/wortel.png",
                "strCategoryDescription": "Dessert is a course that concludes a meal..."
            }
            ...
            data = {
                "idCategory": "9",
                "strCategory": "Brokoli",
                "strCategoryThumb": "http://192.168.0.192:5000/img/brokoli.png",
                "strCategoryDescription": "Dessert is a course that concludes a meal..."
            }
        else:
